...
const stop_script_template_regex = new RegExp(
 ...
 * @param {number} start
 * @param {import("../../../public.js").Element[] | undefined} outer_elements
...
export default function(
	...
	const node = substitution(text.length)
