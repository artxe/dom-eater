 ...
 * @param {number} start
 * @param {import("../../../public.js").Element[] | undefined} elements
 * @param {import("../../../private.js").Bracket} bracket
 * @returns {import("../../../public.js").String & { subType: "backtick" }}
 */
export default function(text, errors, start, elements, bracket) {
	...
	for (;;) {
		...
		if (child_index >= 0) {
			...
			const node = parse_script_template(text, errors, index, elements, bracket)
			scripts.push(node)
			...
			/** @type {import("../../../public.js").String & { subType: "backtick" }} */
			const node = {
				end: text.length,
				scripts,
				start,
